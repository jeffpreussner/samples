...
class URE_Front_End_Menu_Access {
    ...
    public function __construct() {
        ...
        // You should monitor: https://core.trac.wordpress.org/ticket/18584
        add_filter('wp_edit_nav_menu_walker', array($this, 'get_walker'), 10, 2);
        ...
        add_filter('wp_nav_menu_objects', array($this, 'hide_menu_items'));
        
    }
    // end of __construct()
    
    
    public function get_walker($walker, $menu_id) {
