...
class adk_theme_options {
    ...
    public function add_admin_menu() {
      ...
      add_submenu_page('acf-options', 'Custom Post Types', 'Custom Post Types', 'manage_options', 'edit.php?post_type=custom_post' );
      add_submenu_page('acf-options', 'Custom Taxonomies', 'Custom Taxonomies', 'manage_options', 'edit.php?post_type=custom_post_tax' );
    }
